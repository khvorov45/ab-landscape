...
The frequent groups appears to have higher titres against them.
...
Figure INSERT shows the age composition of the frequent and the infrequent groups. There are a few more older individuals in the frequent group and a few more yonger individuals in the infrequent group, but the overall age distribution is similar in both groups.

Figure INSERT shows the average titre against the four Bilthoven viruses for
the individuals split into three age groups (born pre-1968, 1969-1980 and post-1980). Figure INSERT shows the GMTs (against the all four Bilthoven viruses that were averaged for each individual) for the frequent and the infrequent groups. The pattern of yonger individuals having lower titres is evident to some extent in the infrequent group. The titres of the frequent group are more heterogenous and do not appear to follow as clear a pattern.
