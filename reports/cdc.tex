...
Post-vaccination GMTs are generally close to the same or higher in the infrequently vaccinated. The pattern of GMTs for the post-season timepoint is close to that
...
\begin{figure}
	...
	\caption{Objective 1 means of weighted average titres agains circulating strains for each group. Split by egg/cell.}
