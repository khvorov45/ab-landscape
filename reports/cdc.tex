...
Bleed dates for each participant are in Figure \ref{fig:cdc-obj1-bleed-dates} and the time difference between vaccination and post-vaccination bleed is in Figure \ref{fig:cdc-obj1-vax-post-days}.
...
\input{../data-summary/cdc-obj1-time-period-summary.tex}

\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{../data-summary/cdc-obj1-vax-post-days.pdf}
	...
	\label{fig:cdc-obj1-vax-post-days}
\end{figure}
...
or post-season and pre-vaccination of the following year. Except for the 4
participants we decided to keep.

The titres for the excluded infected participants are in Figure \ref{fig:cdc-obj2-hi-excluded}.

\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{../data-summary/cdc-obj2-hi-excluded.pdf}
	\caption{
	...
	\label{fig:cdc-obj2-hi-excluded}
\end{figure}
...
The list of viruses for each clade is in Table \ref{tab:cdc-clade-viruses}. Frequencies of different virus clades during the study period are in Figure \ref{fig:cdc-clade-freq}. The timing of sample collection is in Figure \ref{fig:cdc-obj2-bleed-dates}. The time differences between vaccination and post-vaccination bleed are in Figure \ref{fig:cdc-obj2-vax-post-days}. The most relevant set of frequencies is the first halves of 2017-2019 for Israel and the second halves of 2016-2018 for Peru as they appear to be the influenza "seasons" that the titres belong to.
...
\input{../data-summary/cdc-obj2-time-period-summary.tex}

\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{../data-summary/cdc-obj2-vax-post-days.pdf}
	\caption{Objective 2 time differences between the pre- and the post-vaccination bleeds. The box plot format is: midline - median, upper and lower hinges - 25th and 75th quartiles, whiskers - largest/smallest value no further than 1.5 times the interquartile range from the hinge.}
	\label{fig:cdc-obj2-vax-post-days}
\end{figure}
...
\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{../data-summary/cdc-obj3-gmts-noninfected-1.pdf}
...
\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{../data-summary/cdc-obj3-gmts-infected-1.pdf}
...
\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{../data-summary/cdc-obj3-gmts-noninfected-2.pdf}
...
\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{../data-summary/cdc-obj3-gmts-infected-2.pdf}
